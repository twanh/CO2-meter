...
from jobs import UpdateRoomValues

# CONSTANTS
EXCEL_FILE_NAME = 'data_test.xlsx'

webdriver_path = os.path.join(os.path.abspath(
    os.path.dirname(__file__)), "webdriver", "chromedriver.exe")

arguments_parser = argparse.ArgumentParser()
arguments_parser.add_argument('uuid', help="De UUID van de sensor")
arguments_parser.add_argument(
    'output',  help="Het excel bestand waarin de metingen moeten worden opgeslagen")
arguments_parser.add_argument(
    "interval",  default=5, help="De interval tussen de metingen")
...
if __name__ == "__main__":
    ...
    print("Initializing the job runner for UpdateRoomValues")

    job_runner = UpdateRoomValues('rooms.json', '/usr/bin/chromedriver')
